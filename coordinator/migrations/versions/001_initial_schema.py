...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "balance_seconds", sa.BigInteger(), nullable=False, server_default="0"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "last_seen", sa.DateTime(), server_default=sa.text("now()"), nullable=False
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_index(
        op.f("ix_transactions_from_user"), "transactions", ["from_user"], unique=False
    )
    op.create_index(op.f("ix_transactions_id"), "transactions", ["id"], unique=False)
    op.create_index(
        op.f("ix_transactions_to_user"), "transactions", ["to_user"], unique=False
    )
